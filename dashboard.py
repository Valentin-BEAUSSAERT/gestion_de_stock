...
#Bouton pour la suppression et la mise à jour
        self.update_button = ttk.Button(self.root, text="Mettre à jour le produit sélectionné", command=lambda : self.update_product_callback(self.name_entry.get(), self.description_entry.get(), self.price_entry.get(), self.quantity_entry.get(), self.category_combobox.get()))
